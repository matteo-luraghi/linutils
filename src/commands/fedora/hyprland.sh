...
# Install packages
yes | sudo dnf install hyprland waybar dunst rofi-wayland wlogout xdg-desktop-portal-hyprland qt5-qtwayland qt6-qtwayland hyprlock wl-clipboard cliphist mate-polkit blueman bluez pavucontrol swww wtype rofimoji
